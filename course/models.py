...
class Course(models.Model):
    ...
    time    = models.CharField('上课时间', max_length=64, blank=False, null=False)      #上课时间
    place   = models.CharField('上课地点', max_length=64, blank=False, null=False)      #上课地点
    school  = models.CharField('开课院系', max_length=32, blank=False, null=False)      #开课院系
    code    = models.CharField('课程代码', max_length=32, blank=False, null=False)      #课程代码
